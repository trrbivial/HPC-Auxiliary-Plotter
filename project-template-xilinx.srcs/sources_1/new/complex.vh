...
localparam CALC_GIVENS_A2_1_CYCS = FL_MUL_CYCS + FL_ADD_CYCS * 2;
localparam CALC_GIVENS_COEF_S_CYCS = CALC_GIVENS_A2_1_CYCS + FL_RECIPROCAL_SQRT_CYCS;
localparam CALC_GIVENS_COEF_C_CYCS = CALC_GIVENS_COEF_S_CYCS + FL_MUL_CYCS;
localparam CALC_GIVENS_COEF_MUL_CYCS = CALC_GIVENS_COEF_C_CYCS + CP_MUL_CYCS;
localparam CALC_GIVENS_COEF_ADD_CYCS = CALC_GIVENS_COEF_MUL_CYCS + CP_ADD_CYCS;
localparam CALC_GIVENS_ROTATIONS_CYCS = CALC_GIVENS_COEF_ADD_CYCS;
