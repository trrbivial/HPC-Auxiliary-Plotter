...
module bram_of_1080p_graph(clka, wea, addra, dina, clkb, addrb, doutb)
/* synthesis syn_black_box black_box_pad_pin="clka,wea[0:0],addra[19:0],dina[3:0],clkb,addrb[19:0],doutb[3:0]" */;
  input clka;
  input [0:0]wea;
  input [19:0]addra;
  input [3:0]dina;
